...
private:
  ...
  void pitchJointTargetCallback(const std_msgs::Float64ConstPtr& msg);
  ...
  void updatePitchJointState();
  void publishPitchJointCommandIfNeeded();
  void updatePitchJointReadyState(const ros::Time& now);
  void invalidatePerchingConstraint(const std::string& reason);
  bool readCurrentPitchJointPosition(double& position) const;
  bool computePerchingCenterWorldFromFk(tf::Vector3& perching_center_world) const;
  ...
  ros::Subscriber pitch_joint_target_sub_;
  ...
  ros::Publisher pitch_joint_command_pub_;
  ros::Publisher pitch_joint_ready_pub_;
  ros::Publisher pitch_joint_locked_angle_pub_;
  ros::Publisher perching_constraint_valid_pub_;
  ...
  bool perching_constraint_valid_;
  ...
  bool perching_pitch_joint_enable_;
  bool pitch_joint_target_initialized_;
  bool pitch_joint_measurement_valid_;
  bool pitch_joint_prev_measurement_valid_;
  bool pitch_joint_prev_command_initialized_;
  bool pitch_joint_ready_;
  bool pitch_joint_drift_fault_;
  ...
  double pitch_joint_measured_position_;
  double pitch_joint_prev_measured_position_;
  double pitch_joint_measured_velocity_;
  double pitch_joint_requested_target_;
  double pitch_joint_last_published_command_;
  double pitch_joint_locked_angle_;
  double pitch_joint_min_;
  double pitch_joint_max_;
  double pitch_joint_max_velocity_;
  double pitch_joint_command_pub_interval_;
  double pitch_joint_position_tolerance_;
  double pitch_joint_velocity_tolerance_;
  double pitch_joint_stable_duration_;
  double pitch_joint_drift_tolerance_;

  std::string pivot_source_;
  std::string perching_takeoff_target_pitch_frame_;
  std::string pitch_joint_name_;
  std::string perching_center_link_name_;
  ...
  std::string pitch_joint_command_topic_;
  std::string pitch_joint_target_topic_;
  std::string pitch_joint_ready_topic_;
  std::string pitch_joint_locked_angle_topic_;
  std::string perching_constraint_valid_topic_;
  ...
  ros::Time pitch_joint_ready_start_time_;
  ros::Time pitch_joint_prev_measurement_time_;
  ros::Time pitch_joint_last_command_pub_time_;
